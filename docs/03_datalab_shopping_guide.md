...
> 출처: https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md

---

# 쇼핑인사이트

- [쇼핑인사이트 개요](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-개요)

- [개요](/docs/serviceapi/datalab/shopping/shopping.md#개요)

- [사전 준비 사항](/docs/serviceapi/datalab/shopping/shopping.md#사전-준비-사항)

- [쇼핑인사이트 API 레퍼런스](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-api-레퍼런스)

- [쇼핑인사이트 분야별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-분야별-트렌드-조회)

- [쇼핑인사이트 분야 내 기기별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-분야-내-기기별-트렌드-조회)

- [쇼핑인사이트 분야 내 성별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-분야-내-성별-트렌드-조회)

- [쇼핑인사이트 분야 내 연령별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-분야-내-연령별-트렌드-조회)

- [쇼핑인사이트 키워드별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-키워드별-트렌드-조회)

- [쇼핑인사이트 키워드 기기별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-키워드-기기별-트렌드-조회)

- [쇼핑인사이트 키워드 성별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-키워드-성별-트렌드-조회)

- [쇼핑인사이트 키워드 연령별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-키워드-연령별-트렌드-조회)

- [오류 코드](/docs/serviceapi/datalab/shopping/shopping.md#오류-코드)

- [쇼핑인사이트 API 구현 예제](/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-api-구현-예제)

- [Java](/docs/serviceapi/datalab/shopping/shopping.md#java)

- [PHP](/docs/serviceapi/datalab/shopping/shopping.md#php)

- [Node.js](/docs/serviceapi/datalab/shopping/shopping.md#node-js)

- [Python](/docs/serviceapi/datalab/shopping/shopping.md#python)

- [C#](/docs/serviceapi/datalab/shopping/shopping.md#c)

## 쇼핑인사이트 개요

- [개요](/docs/serviceapi/datalab/shopping/shopping.md#%EA%B0%9C%EC%9A%94)

- [사전 준비 사항](/docs/serviceapi/datalab/shopping/shopping.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)
...
- 네이버 개발자 센터의 메뉴에서 [**Application > 애플리케이션 등록**](https://developers.naver.com/apps/#/wizard/register)을 선택합니다.
...
- **애플리케이션 등록 (API이용신청)** 페이지에서 [애플리케이션 등록 세부 정보](/docs/serviceapi/datalab/shopping/shopping.md#%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98-%EB%93%B1%EB%A1%9D-%EC%84%B8%EB%B6%80-%EC%A0%95%EB%B3%B4)를 입력한 다음 **등록하기**를 클릭합니다.
...
- **사용 API**에서 **데이터랩 (쇼핑인사이트)**를 선택해 추가합니다.

- [**비로그인 오픈 API 서비스 환경**](https://developers.naver.com/docs/common/openapiguide/appregister.md#%EB%B9%84%EB%A1%9C%EA%B7%B8%EC%9D%B8-%EC%98%A4%ED%94%88-api-%EC%84%9C%EB%B9%84%EC%8A%A4-%ED%99%98%EA%B2%BD)에서 애플리케이션을 서비스할 환경을 추가하고 필요한 상세 정보를 입력합니다.
...
- [쇼핑인사이트 분야별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 분야 내 기기별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC-%EB%82%B4-%EA%B8%B0%EA%B8%B0%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 분야 내 성별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC-%EB%82%B4-%EC%84%B1%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 분야 내 연령별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC-%EB%82%B4-%EC%97%B0%EB%A0%B9%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 키워드별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 키워드 기기별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C-%EA%B8%B0%EA%B8%B0%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 키워드 성별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C-%EC%84%B1%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [쇼핑인사이트 키워드 연령별 트렌드 조회](/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C-%EC%97%B0%EB%A0%B9%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)

- [오류 코드](/docs/serviceapi/datalab/shopping/shopping.md#%EC%98%A4%EB%A5%98-%EC%BD%94%EB%93%9C)
...
| ages | array(JSON) | N | 연령. 검색 사용자의 연령에 따른 조건입니다.- 설정 안 함: 모든 연령- 10: 10∼19세- 20: 20∼29세- 30: 30∼39세- 40: 40∼49세- 50: 50∼59세- 60: 60세 이상 |
...
| timeUnit | string | 구간 단위- date: 일간- week: 주간- month: 월간 |
...
| results.category | string | 쇼핑 분야 코드 |
| results.data.period | string | 구간별 시작 날짜(yyyy-mm-dd 형식) |
| results.data.group | string | 기기. 검색 환경에 따른 조건입니다.- pc: PC에서의 검색 클릭 추이- mo: 모바일 기기에서의 검색 클릭 추이 |
| results.data.ratio | number | 구간별 클릭량의 상대적 비율. 구간별 결과에서 가장 큰 값을 100으로 설정한 상댓값입니다. |
...
| results.category | string | 쇼핑 분야 코드 |
| results.data.period | string | 구간별 시작 날짜(yyyy-mm-dd 형식) |
| results.data.group | string | 성별. 검색 사용자의 성별에 따른 조건입니다.- m: 남성- f: 여성 |
| results.data.ratio | number | 구간별 클릭량의 상대적 비율. 구간별 결과에서 가장 큰 값을 100으로 설정한 상댓값입니다. |
...
| results.category | string | 쇼핑 분야 코드 |
| results.data.period | string | 구간별 시작 날짜(yyyy-mm-dd 형식) |
| results.data.group | string | 연령. 검색 사용자의 연령에 따른 조건입니다.- 10: 10∼19세- 20: 20∼29세- 30: 30∼39세- 40: 40∼49세- 50: 50∼59세- 60: 60세 이상 |
| results.data.ratio | number | 구간별 클릭량의 상대적 비율. 구간별 결과에서 가장 큰 값을 100으로 설정한 상댓값입니다. |
